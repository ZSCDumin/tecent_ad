...
from pretrain import lstm as lstm
...
if __name__ == "__main__":
    ...
    model = lstm.baseline_model(emb_dims=EMBED_SIZE,
                                seq_len=SEQ_LEN,
                                attn_size=ATTN_SIZE,          
                                num_class=NUM_CLASS,
                                device=device,
    ...
    optimizer = torch.optim.Adam(model.parameters(), lr=0.0001) # Adam 0.01
