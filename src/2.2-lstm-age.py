...
if __name__ == "__main__":
    ...
    #dataset
    train_ds=dataset.seq_dataset(train_df,seq_len=SEQ_LEN,cols_seq=COLS, col_y="age",)
    val_ds=dataset.seq_dataset(val_df,seq_len=SEQ_LEN,cols_seq=COLS,col_y="age",)
    ...
    optimizer = torch.optim.SGD(model.parameters(),momentum=0.9,lr=0.4)#SGD 0.2
    scheduler = torch.optim.lr_scheduler.StepLR(optimizer,step_size=1,gamma=0.4) #0.2
